...
//	 * @return
//	 */
//	public boolean pay(final String strOrderInfo, final Activity activity, final Handler handler) {
//		if (mbPaying)
//			return false;
//		mbPaying = true;
//		mHandler =handler;
...
//					// 调用支付接口，获取支付结果
//					String strRet = alipay.pay(strOrderInfo);
...
////			if(!arg1.equals("9000") && mHandler !=null){
////				Message msg =new Message();
////				msg.what = AlixId.RQF_PAY_BACK;
