...
public class HaiWebView extends WebView {
  ...
  public HaiWebView(Context context) {
    super(context);
    init();
  }

  public HaiWebView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }

  public HaiWebView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public static class WebViewClientListener {
     ...
     * @param newProgress Current page loading doProgress, represented by
